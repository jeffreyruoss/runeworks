...
export const SPRITES = [
...

  {
    ...
    flatten: '#06050f',
    prompt:
      'Pixel art horizontal ornate border strip for a dark fantasy UI panel, front-facing (NOT top-down), ' +
      '16-bit SNES-era style, crisp pixel edges. ' +
      'The sprite should be 48x8 logical pixels shown at large scale. ' +
      'IMPORTANT: This is a seamless tileable texture — the pattern MUST repeat seamlessly when tiled ' +
      'LEFT to RIGHT. No seams when repeated horizontally. ' +
      'The ENTIRE sprite must be filled solid with NO transparent pixels, NO checkerboard. ' +
      'A horizontal ornate dark iron border strip with subtle cyan-blue rune etchings running along its length. ' +
      'The top edge (outermost edge of the panel border) should have a thin bright iron highlight line. ' +
      'Below that: dark iron metal body with faint engraved rune symbols repeating along the strip. ' +
      'The bottom edge transitions to very dark near-black purple (#06050f) panel interior. ' +
      'Color scheme: dark iron gray metal, faint cyan-blue rune accents, purple-gray highlights.',
  },
  // panel_edge_v is auto-generated by pack-atlas.js (rotates panel_edge_h 90°)
  {
    name: 'panel_corner',
    width: 8,
    height: 8,
    flatten: '#06050f',
    prompt:
      'Pixel art corner piece for a dark fantasy UI panel frame, front-facing (NOT top-down), ' +
      '16-bit SNES-era style, crisp pixel edges. ' +
      'The sprite should be 8x8 logical pixels shown at large scale. ' +
      'This is the TOP-LEFT corner of an ornate panel border. ' +
      'The ENTIRE sprite must be filled solid with NO transparent pixels, NO checkerboard. ' +
      'A small metal rivet or gothic flourish at the corner where two iron border strips meet. ' +
      'Top and left edges: bright iron highlight line (the outermost border). ' +
      'Bottom-right area transitions to very dark near-black purple (#06050f) panel interior. ' +
      'A small decorative dot or rivet near the corner for visual interest. ' +
